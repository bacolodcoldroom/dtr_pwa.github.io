   ...
   dtl2=      
    '<div style="width:100%;height:100%;background:none;">'+
      ...
      '<div onclick="refMap()" style="float:left;width:20%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+        
        '<div class="footer_gfxs">'+
          '<img src="gfx/jrefresh.png"  style="height:100%;" alt="save image" />'+
        '</div>'+
      ...
      '<div onclick="gotoMarker(marker_client)" style="float:left;width:20%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+        
        '<div class="footer_gfxs">'+
          '<img src="gfx/jsite.png"  style="height:100%;" alt="save image" />'+
        '</div>'+
      ...
      '<div onclick="showRoute()" style="float:right;width:20%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+        
        '<div class="footer_gfxs">'+
          '<img src="gfx/jsend.png"  style="height:100%;" alt="del image" />'+
        '</div>'+
    ...
    '</div>';
      ...
      '<div style="width:100%;height:100%;background:none;">'+
        ...
        '<div class="cls_map_input" style="color:'+JBE_TXCLOR1+';background:none;">'+        
          '<input id="inpLat" type="number" disabled>'+
          '<span>Latitude</span>'+
        '</div>'+
       
        '<div class="cls_map_input" style="color:'+JBE_TXCLOR1+';background:none;">'+        
          '<input id="inpLng" type="number" disabled>'+
          '<span>Longitude</span>'+
        '</div>'+        
        
        '<div id="divCANCEL" onclick="procSave(0)" style="float:right;width:20%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+        
          '<div class="class_footer">'+
            '<img id="imgCancel" src="gfx/jsite.png" alt="call image" />'+
            '<span id="txtCancel">Auto</span>'+
          '</div>'+
        '</div>'+

        

        '<div onclick="procSave(1)" style="float:right;width:18%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+        
          
          '<div class="class_footer">'+
            '<img id="imgLatLng" src="gfx/jedit.png" alt="call image" />'+
            '<span id="txtLatLng">Edit</span>'+
          '</div>'+
        '</div>'+
...
function procSave(vm){
	...
	var vsrc='gfx/jedit.png';
	var vsrc2='gfx/jsite.png';
	var vcap='Edit';
	var vcap2='Auto';
	var vdis1=true;
	var vdis2=true;
...
function showClientBox(meLat,meLng){ 
  ...
  var poptxt ='<div style="width:250px;height:auto;margin-top:20px;z-index:500;">' +
                ...
                '   <img src="gfx/jcall.png" onclick="callTextGO(&quot;call&quot;,&quot;'+vcelno+'&quot;)" style="float:left;margin-left:4%;height:100%;"/>' +
                '   <img src="gfx/jsms.png"  onclick="callTextGO(&quot;txt&quot; ,&quot;'+vcelno+'&quot;)" style="float:right;margin-right:4%;height:100%;"/>' +     
                '</div>'+
              '</div>';    
...
function saveUserPosition(lat,lng){
  ...
  */ 
  axios.put('/api/upd_loc', {headers: { 'Content-Type': 'application/json' }}, { params: { 
    lat:lat,
    lng:lng,
    usercode: usercode, 
